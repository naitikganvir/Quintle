...
const Footer = () => {
  return (
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <Link href={"/"} className="text-3xl">
              <span className="text-rose-600">Q</span>uintle
            </Link>
   ...
   Empowering the world
        ...
        <p className="mt-8 text-xs">© 2024 Quick - All rights reserved</p>
      </div>
    </footer>
  );
};
